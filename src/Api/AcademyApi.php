...
class AcademyApi
{
    ...
    /**
     * Operation academyTranscript
     */
    public function academyTranscript($cid)
    {
        $request = $this->academyTranscriptGetRequest($cid);
    ...
    protected function academyTranscriptGetRequest($cid)
    {
        ...
        $resourcePath = '/academy/transcript/{cid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
