...
class FacilityApi
{
     ...
     */
    public function facilityIdRosterGet($id)
    {
        list($response) = $this->facilityIdRosterGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation facilityIdRosterGetWithHttpInfo
     *
     * Get facility roster.
     *
     * @param  string $id Facility IATA ID (required)
     ...
     */
    public function facilityIdRosterGetWithHttpInfo($id)
    {
        $returnType = '\VATUSA\Client\Model\User[]';
        $request = $this->facilityIdRosterGetRequest($id);
    ...
    /**
     * Operation facilityIdRosterGetAsync
     *
     * Get facility roster.
     *
     * @param  string $id Facility IATA ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function facilityIdRosterGetAsync($id)
    {
        return $this->facilityIdRosterGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation facilityIdRosterGetAsyncWithHttpInfo
     *
     * Get facility roster.
     *
     * @param  string $id Facility IATA ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function facilityIdRosterGetAsyncWithHttpInfo($id)
    {
        $returnType = '\VATUSA\Client\Model\User[]';
        $request = $this->facilityIdRosterGetRequest($id);
    ...
    /**
     * Create request for operation 'facilityIdRosterGet'
     *
     * @param  string $id Facility IATA ID (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function facilityIdRosterGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling facilityIdRosterGet'
            );
        }

        $resourcePath = '/facility/{id}/roster';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
