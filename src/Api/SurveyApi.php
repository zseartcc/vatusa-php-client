...
class SurveyApi
{
    ...
    /**
     * Operation surveyIdAssignCidPost
     *
     ...
     */
    public function surveyIdAssignCidPost($id, $cid)
    {
        list($response) = $this->surveyIdAssignCidPostWithHttpInfo($id, $cid);
        return $response;
    }

    /**
     * Operation surveyIdAssignCidPostWithHttpInfo
     *
     * Assign a survey to cid. [Private]
     *
     * @param  int $id Survey ID (required)
     ...
     */
    public function surveyIdAssignCidPostWithHttpInfo($id, $cid)
    {
        $returnType = '\VATUSA\Client\Model\OK';
        $request = $this->surveyIdAssignCidPostRequest($id, $cid);
    ...
    /**
     * Operation surveyIdAssignCidPostAsync
     *
     * Assign a survey to cid. [Private]
     *
     * @param  int $id Survey ID (required)
     ...
     */
    public function surveyIdAssignCidPostAsync($id, $cid)
    {
        return $this->surveyIdAssignCidPostAsyncWithHttpInfo($id, $cid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation surveyIdAssignCidPostAsyncWithHttpInfo
     *
     * Assign a survey to cid. [Private]
     *
     * @param  int $id Survey ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function surveyIdAssignCidPostAsyncWithHttpInfo($id, $cid)
    {
        $returnType = '\VATUSA\Client\Model\OK';
        $request = $this->surveyIdAssignCidPostRequest($id, $cid);
    ...
    /**
     * Create request for operation 'surveyIdAssignCidPost'
     *
     * @param  int $id Survey ID (required)
     * @param  int $cid CERT ID (required)
     *
     ...
     */
    protected function surveyIdAssignCidPostRequest($id, $cid)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling surveyIdAssignCidPost'
            );
        }
        // verify the required parameter 'cid' is set
        if ($cid === null || (is_array($cid) && count($cid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cid when calling surveyIdAssignCidPost'
            );
        }

        $resourcePath = '/survey/{id}/assign/{cid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation surveyIdGet
     *
     * Get survey questions. [Private]
     *
     * @param  string $id Survey Assignment ID (required)
     *
     * @throws \VATUSA\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->surveyIdGetWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation surveyIdGetWithHttpInfo
     *
     * Get survey questions. [Private]
     *
     * @param  string $id Survey Assignment ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function surveyIdGetAsync($id)
    {
        return $this->surveyIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation surveyIdGetAsyncWithHttpInfo
     *
     * Get survey questions. [Private]
     *
     * @param  string $id Survey Assignment ID (required)
    ...
    /**
     * Create request for operation 'surveyIdGet'
     *
     * @param  string $id Survey Assignment ID (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function surveyIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling surveyIdGet'
            );
        }
     ...
     * @return \VATUSA\Client\Model\OK
     */
    public function surveyIdPost($id, $data)
    {
        list($response) = $this->surveyIdPostWithHttpInfo($id, $data);
        return $response;
    }

    /**
     * Operation surveyIdPostWithHttpInfo
     *
     * Submit survey. [Private]
     *
     * @param  string $id Survey Assignment ID (required)
     ...
     * @return array of \VATUSA\Client\Model\OK, HTTP status code, HTTP response headers (array of strings)
     */
    public function surveyIdPostWithHttpInfo($id, $data)
    {
        $returnType = '\VATUSA\Client\Model\OK';
        $request = $this->surveyIdPostRequest($id, $data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function surveyIdPostAsync($id, $data)
    {
        return $this->surveyIdPostAsyncWithHttpInfo($id, $data)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation surveyIdPostAsyncWithHttpInfo
     *
     * Submit survey. [Private]
     *
     * @param  string $id Survey Assignment ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function surveyIdPostAsyncWithHttpInfo($id, $data)
    {
        $returnType = '\VATUSA\Client\Model\OK';
        $request = $this->surveyIdPostRequest($id, $data);
    ...
    /**
     * Create request for operation 'surveyIdPost'
     *
     * @param  string $id Survey Assignment ID (required)
     * @param  string $data (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function surveyIdPostRequest($id, $data)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling surveyIdPost'
            );
        }
        // verify the required parameter 'data' is set
        if ($data === null || (is_array($data) && count($data) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $data when calling surveyIdPost'
            );
        }
