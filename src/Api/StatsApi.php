...
class StatsApi
{
    ...
    /**
     * Operation statsExamsFacilityGet
     *
     * Get statistics of exam results. [Key]
     *
     * @param  string $facility Filter for facility IATA ID (required)
     * @param  int $month Filter by month number, requires year (optional)
     * @param  int $year 4 digit year to limit results by (optional)
     *
    ...
    {
        list($response) = $this->statsExamsFacilityGetWithHttpInfo($facility, $month, $year);
        return $response;
    }

    /**
     * Operation statsExamsFacilityGetWithHttpInfo
     *
     * Get statistics of exam results. [Key]
     *
     * @param  string $facility Filter for facility IATA ID (required)
    ...
    /**
     * Operation statsExamsFacilityGetAsync
     *
     * Get statistics of exam results. [Key]
     *
     * @param  string $facility Filter for facility IATA ID (required)
     ...
     */
    public function statsExamsFacilityGetAsync($facility, $month = null, $year = null)
    {
        return $this->statsExamsFacilityGetAsyncWithHttpInfo($facility, $month, $year)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation statsExamsFacilityGetAsyncWithHttpInfo
     *
     * Get statistics of exam results. [Key]
     *
     * @param  string $facility Filter for facility IATA ID (required)
    ...
    /**
     * Create request for operation 'statsExamsFacilityGet'
     *
     * @param  string $facility Filter for facility IATA ID (required)
     * @param  int $month Filter by month number, requires year (optional)
     * @param  int $year 4 digit year to limit results by (optional)
     ...
     */
    protected function statsExamsFacilityGetRequest($facility, $month = null, $year = null)
    {
        // verify the required parameter 'facility' is set
        if ($facility === null || (is_array($facility) && count($facility) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $facility when calling statsExamsFacilityGet'
            );
        }

        $resourcePath = '/stats/exams/{facility}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
