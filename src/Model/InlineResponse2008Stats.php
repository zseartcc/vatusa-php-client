...
/**
 * InlineResponse2008Stats Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008Stats implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_stats';
    ...
    {
        $this->container['controllers'] = isset($data['controllers']) ? $data['controllers'] : null;
        $this->container['pendingTransfers'] = isset($data['pendingTransfers']) ? $data['pendingTransfers'] : null;
    }
     ...
     * Sets controllers
     *
     * @param int $controllers Number of controllers on     facility roster
     *
     * @return $this
     */
     ...
     *
     * @param int $pendingTransfers Number of pending     transfers to facility
     *
     * @return $this
     */
