...
/**
 * KnowledgebaseCategories Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KnowledgebaseCategories implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KnowledgebaseCategories';
    ...
    protected static $swaggerTypes = [
        'id' => 'int',
        'name' => 'int',
        'questions' => '\VATUSA\Client\Model\KnowledgebaseQuestions[]',
        'createdAt' => 'string'
    ];
     ...
     * Sets id
     *
     * @param int $id Class KnowledgebaseCategories
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param int $name Class KnowledgebaseCategories
     *
     * @return $this
     */
     ...
     * Gets questions
     *
     * @return \VATUSA\Client\Model\KnowledgebaseQuestions[]
     */
     ...
     * Sets questions
     *
     * @param \VATUSA\Client\Model\KnowledgebaseQuestions[] $questions Class KnowledgebaseCategories
     *
     * @return $this
     */
     ...
     * Sets createdAt
     *
     * @param string $createdAt Class KnowledgebaseCategories
     *
     * @return $this
     */
