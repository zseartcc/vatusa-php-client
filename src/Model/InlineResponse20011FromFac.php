...
/**
 * InlineResponse20011FromFac Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20011FromFac implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_11_fromFac';
     ...
     * Sets id
     *
     * @param int $id Facility ID (ex. ZSE)
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param int $name Facility Name (ex.     Seattle ARTCC)
     *
     * @return $this
     */
