...
/**
 * DeleteSoloRequest Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DeleteSoloRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'deleteSoloRequest';
     ...
     * Sets id
     *
     * @param float $id Endorsement ID. Use this      *                           OR both CID and Position.
     *
     * @return $this
     */
