...
/**
 * InlineResponse20012Paths Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20012Paths implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_12_paths';
     ...
     * Sets order
     *
     * @param int $order ID used in ULS query
     *
     * @return $this
     */
     ...
     * Sets facilityId
     *
     * @param string $facilityId Facility assocaited with     path
     *
     * @return $this
     */
