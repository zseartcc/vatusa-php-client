...
/**
 * EmailAccounts Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailAccounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailAccounts';
     ...
     * Sets id
     *
     * @param int $id Class EmailAccounts
     *
     * @return $this
     */
     ...
     * Sets facility
     *
     * @param string $facility First name
     *
     * @return $this
     */
