...
namespace VATUSA\PHPClient\Model;

use \ArrayAccess;
use \VATUSA\PHPClient\ObjectSerializer;

/**
 * TmunoticestmufacidTmuFacility Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\PHPClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TmunoticestmufacidTmuFacility implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmunoticestmufacid_tmu_facility';
     ...
     * Sets id
     *
     * @param string $id TMU Facility ID
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name TMU Facility Name
     *
     * @return $this
     */
     ...
     * Sets parent
     *
     * @param string $parent Parent TMU Facility/ARTCC
     *
     * @return $this
     */
