...
/**
 * NewSoloRequest Class Doc Comment
 *
 * @category Class
 * @package  VATUSA\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NewSoloRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'newSoloRequest';
     ...
     * Sets expDate
     *
     * @param string $expDate Date of expiration     (YYYY-MM-DD)
     *
     * @return $this
     */
